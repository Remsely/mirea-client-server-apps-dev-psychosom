...
@Component
class AuthPsychologistIdResolver(
    private val authCredentialsAnnotationsProvider: AuthCredentialsAnnotationsProvider
) : HandlerMethodArgumentResolver {
    override fun supportsParameter(parameter: MethodParameter): Boolean =
        parameter.getParameterAnnotation(AuthPsychologistId::class.java) != null &&
    ...
    ): Any = authCredentialsAnnotationsProvider.getPsychologistId()
}
